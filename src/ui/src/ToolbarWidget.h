...
// appearance · panel toggles. Camera controls (Views / Fit / projection) and
// zero-chrome live only in the viewport HUD — they act on the drawing area, so
// they sit on it, and duplicating them here read as two competing toolbars.
// The active filename lives in the document tab bar below, not in the toolbar.
